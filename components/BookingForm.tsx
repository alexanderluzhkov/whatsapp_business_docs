...
export default function BookingForm({
  ...
  return (
    <div
      className="fixed inset-0 z-50 flex items-center justify-center p-2 sm:p-4 bg-black bg-opacity-50 animate-fadeIn"
      onClick={onClose}
    >
      {/* Modal Content */}
      <div
        className="bg-white rounded-lg shadow-xl w-full max-w-full sm:max-w-2xl max-h-[95vh] sm:max-h-[90vh] overflow-y-auto animate-scaleIn"
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div>
                    <input
                      ...
                      className="w-full px-3 sm:px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none text-base"
                    />
                  </div>
                  <div>
                    <input
          ...
          <div className="flex gap-2 sm:gap-3 pt-4 border-t border-gray-200">
            {editMode && (
              <button
                ...
                disabled={isSaving}
                className="px-4 py-3 min-h-[44px] bg-red-600 hover:bg-red-700 active:bg-red-800 text-white font-medium rounded-lg transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
              >
                Удалить
              </button>
            )}
            <button
              ...
              onClick={onClose}
              disabled={isSaving}
              className="flex-1 px-4 py-3 min-h-[44px] bg-gray-200 hover:bg-gray-300 active:bg-gray-400 text-gray-900 font-medium rounded-lg transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
            >
              Отмена
            </button>
            <button
              ...
              className="flex-1 px-4 py-3 min-h-[44px] bg-blue-600 hover:bg-blue-700 active:bg-blue-800 text-white font-medium rounded-lg transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
            >
